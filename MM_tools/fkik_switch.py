...
def create_fkik_switch(side, *args):
    ...
    for item in required_objects:
        if cmds.objExists(side + item) == True:
            continue
        else:
            missing_object = True
    ...
    cmds.spaceLocator(n = side + '_leg_FKIK_switch', p = hip_pos, a = True)
    ...
    cmds.circle(n = side + '_foot_IK_ctl', ch = False)
    ...
    cmds.setDrivenKeyframe(side + '_hip_jnt_parentConstraint1.' + side +'_hip_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_hip_jnt_parentConstraint1.' + side +'_hip_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_hip_jnt_parentConstraint1.' + side +'_hip_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 1)
    cmds.setDrivenKeyframe(side + '_hip_jnt_parentConstraint1.' + side +'_hip_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 0)


    cmds.setDrivenKeyframe(side + '_knee_jnt_parentConstraint1.' + side +'_knee_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_knee_jnt_parentConstraint1.' + side +'_knee_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_knee_jnt_parentConstraint1.' + side +'_knee_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 1)
    cmds.setDrivenKeyframe(side + '_knee_jnt_parentConstraint1.' + side +'_knee_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 0)


    cmds.setDrivenKeyframe(side + '_ball_jnt_parentConstraint1.' + side +'_ball_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_ball_jnt_parentConstraint1.' + side +'_ball_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_ball_jnt_parentConstraint1.' + side +'_ball_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 1)
    cmds.setDrivenKeyframe(side + '_ball_jnt_parentConstraint1.' + side +'_ball_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 0)


    cmds.setDrivenKeyframe(side + '_ankle_jnt_parentConstraint1.' + side +'_ankle_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_ankle_jnt_parentConstraint1.' + side +'_ankle_FK_jntW1', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_ankle_jnt_parentConstraint1.' + side +'_ankle_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 1)
    cmds.setDrivenKeyframe(side + '_ankle_jnt_parentConstraint1.' + side +'_ankle_IK_jntW0', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 0)

    #IK controller
    cmds.setDrivenKeyframe(side + '_foot_IK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 1)
    cmds.setDrivenKeyframe(side + '_foot_IK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 0)

    #FK controllers
    cmds.setDrivenKeyframe(side + '_ankle_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_ankle_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_knee_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_knee_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_hip_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_hip_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)

    cmds.setDrivenKeyframe(side + '_ball_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 0 , v = 0)
    cmds.setDrivenKeyframe(side + '_ball_FK_ctl.v', cd = side + '_leg_FKIK_switch.FKIKSwitch',dv = 1 , v = 1)
